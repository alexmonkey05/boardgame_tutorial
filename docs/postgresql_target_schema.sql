...
ALTER TABLE games ADD COLUMN IF NOT EXISTS data_source_url TEXT;
ALTER TABLE games ADD COLUMN IF NOT EXISTS data_license TEXT;
ALTER TABLE games ADD COLUMN IF NOT EXISTS content_license TEXT;
ALTER TABLE games ADD COLUMN IF NOT EXISTS reviewed_at DATE;
ALTER TABLE games ADD COLUMN IF NOT EXISTS reviewed_by TEXT;
